...
let ProducDetails = class ProducDetails {
    cartservice;
    global;
    router;
    productservice;
    ...
    constructor(cartservice, global, router, productservice, route, cdr) {
    ...
    AddToCartandView() {
        ...
        const goToCart = confirm('Item added to cart.\n\nPress OK → Go to Cart\nPress Cancel → Continue Shopping');
        if (goToCart) {
...
__decorate([
    Output()
], ProducDetails.prototype, "deleteevent", void 0);
ProducDetails = __decorate([
    Component({
